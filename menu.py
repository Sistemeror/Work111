...
main_menu.add(
    types.InlineKeyboardButton(text='🙋🏻‍♂️ Реф система', callback_data='referral_web'),
...
# Worker menu
worker_menu = types.InlineKeyboardMarkup(row_width=2)
worker_menu.add(types.InlineKeyboardButton(text='Изменить баланс', callback_data='give_balance'))
worker_menu.add(types.InlineKeyboardButton(text='Топ рефералов ', callback_data='admin_top_ref'))
...
popolnenie.add(
    types.InlineKeyboardButton(text='💸 USDT (TRC20)', callback_data='usdt'),
    types.InlineKeyboardButton(text='💰 Bitcoin', callback_data='bitcoin'),
    types.InlineKeyboardButton(text='💳 Карта', callback_data='karta'),
    types.InlineKeyboardButton(text='Назад', callback_data='exit_to_menu')
)
...
def replenish_balance(code):
    replenish_balance = types.InlineKeyboardMarkup(row_width=1)
